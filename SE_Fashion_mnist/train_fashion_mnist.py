...
batch_size = 112 if model_type == "wrn" else 56
...
if K.image_data_format() == "th":
    init = (1, img_rows, img_cols)
else:
    init = (img_rows, img_cols, 1)
...
with open(model_prefix + '_best_single_model.txt', mode='w') as f:
    f.write('Best_single_model has Accuracy %3.4f and Error rate %3.4f' % (accuracy, error))